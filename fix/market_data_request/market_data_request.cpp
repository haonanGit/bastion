...
public:
  ...
  void marketDataRequestSend(const FIX::SessionID &session_id) {
    ...
    no_related_sym.set(FIX::Symbol("ETH-PERPETUAL"));
...
int main(int argc, char **argv) {
  // std::cout << "test base64:" << common::Base64Encode(reinterpret_cast<const
  // unsigned char*>("compute sha1"), strlen("compute sha1")) << std::endl;
  // std::cout << "test albert sha256:" << common::sha256("albert") <<
  // std::endl;
